// NNavvBarr - Updated September 23, 2025
function noop() { }
const identity = x => x;
...
function get_each_context_1(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[7] = list[i].link;
	child_ctx[10] = list[i].subnav;
	return child_ctx;
}

function get_each_context_2(ctx, list, i) {
	const child_ctx = ctx.slice();
	child_ctx[13] = list[i].sublink;
	return child_ctx;
}
...
function create_if_block_3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(img, "class", "svelte-1mqcwlj");
			attr(a, "href", "/");
			attr(a, "class", "svelte-1mqcwlj");
		},
		m(target, anchor) {
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "link svelte-1mqcwlj");
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 1 && t_value !== (t_value = /*link*/ ctx[7].label + "")) set_data(t, t_value);

			if (dirty & /*nav*/ 1 && a_href_value !== (a_href_value = /*link*/ ctx[7].url)) {
...
// (210:12) {#if subnav && subnav.length}
function create_if_block_1(ctx) {
	let ul;
	let each_value_2 = /*subnav*/ ctx[10];
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(ul, "class", "submenu svelte-1mqcwlj");
		},
		m(target, anchor) {
...
// (212:12) {#each subnav as {sublink}}
function create_each_block_2(ctx) {
	let li;
	let a;
	let t0_value = /*sublink*/ ctx[13].label + "";
	let t0;
	let a_href_value;
	let t1;
	...
	return {
		...
		h() {
			attr(a, "href", a_href_value = /*sublink*/ ctx[13].url);
			attr(a, "class", "sublink svelte-1mqcwlj");
			attr(li, "class", "svelte-1mqcwlj");
			toggle_class(li, "active", /*sublink*/ ctx[13].active);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*nav*/ 1 && t0_value !== (t0_value = /*sublink*/ ctx[13].label + "")) set_data(t0, t0_value);

			if (dirty & /*nav*/ 1 && a_href_value !== (a_href_value = /*sublink*/ ctx[13].url)) {
				attr(a, "href", a_href_value);
			}
...
// (205:8) {#each nav as {link, subnav}}
function create_each_block_1(ctx) {
	let li;
	let t0;
	let t1;
	let if_block0 = /*link*/ ctx[7] && create_if_block_2(ctx);
	let if_block1 = /*subnav*/ ctx[10] && /*subnav*/ ctx[10].length && create_if_block_1(ctx);
	...
	return {
		...
		h() {
			attr(li, "class", "svelte-1mqcwlj");
			toggle_class(li, "active", /*link*/ ctx[7].active);
		},
		m(target, anchor) {
			insert_hydration(target, li, anchor);
		...
		p(ctx, dirty) {
			...
			if (/*subnav*/ ctx[10] && /*subnav*/ ctx[10].length) {
				if (if_block1) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1mqcwlj");
			attr(nav_1, "id", "popup");
			attr(nav_1, "class", "svelte-1mqcwlj");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*image*/ ctx[1].url && create_if_block_3(ctx);
	...
	let if_block1 = /*mobileNavOpen*/ ctx[2] && create_if_block(ctx);
	...
	return {
		...
		l(nodes) {
			...
			var nav_1_nodes = children(nav_1);
			div0 = claim_element(nav_1_nodes, "DIV", { class: true });
			...
			div1 = claim_element(nav_1_nodes, "DIV", { id: true, class: true });
			var div1_nodes = children(div1);
			button = claim_element(div1_nodes, "BUTTON", { "aria-label": true });
			var button_nodes = children(button);
			claim_component(icon.$$.fragment, button_nodes);
			button_nodes.forEach(detach);
			div1_nodes.forEach(detach);
			t2 = claim_space(nav_1_nodes);
			if (if_block1) if_block1.l(nav_1_nodes);
			nav_1_nodes.forEach(detach);
		...
		h() {
			attr(div0, "class", "logo_wrapper svelte-1mqcwlj");
			attr(ul, "class", "svelte-1mqcwlj");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "id", "open");
			attr(div1, "class", "svelte-1mqcwlj");
			attr(nav_1, "class", "svelte-1mqcwlj");
			attr(div2, "class", "section-container");
			attr(div3, "class", "background svelte-1mqcwlj");
			attr(div3, "id", "top");
		},
		m(target, anchor) {
			...
			if (if_block1) if_block1.m(nav_1, null);
			current = true;
...
function instance($$self, $$props, $$invalidate) {
	...
	return [nav, image, mobileNavOpen, props, click_handler, click_handler_1];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 3, nav: 0, image: 1 });
	}
}
